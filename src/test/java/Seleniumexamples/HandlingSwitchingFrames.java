...
public class HandlingSwitchingFrames extends BaseSelenium{
    ...
    public void verifySwitchingToChildFrames(){
        ...
        webDriverWait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.cssSelector("[name='frame-top']")));
        webDriverWait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("frame-left"));
        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//body[normalize-space()='LEFT']"))).isDisplayed();
        driver.switchTo().parentFrame();
        webDriverWait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.cssSelector("[name='frame-right']")));
